...
const useGetSystemDepartmentPaginated = (
 enabled: boolean, setEnabled: React.Dispatch<React.SetStateAction<boolean>>, page:number = 1, size:number = 10
) => {
  const location = useLocation();
  const history = useHistory();
  const dispatch = useDispatch();
...
const useGetSystemDepartment = (
 enabled: boolean, setEnabled: React.Dispatch<React.SetStateAction<boolean>>, all:string
) => {
  const location = useLocation();
  const history = useHistory();
  const dispatch = useDispatch();
...
const useGetSystemCountry = (enabled:boolean, setEnabled: React.Dispatch<React.SetStateAction<boolean>>, all:string) => {
  const location = useLocation();
  const history = useHistory();
  const dispatch = useDispatch();
  const request = useAxiosPrivate();
...
const useGetSystemCountryPaginated = (enabled: boolean, setEnabled: React.Dispatch<React.SetStateAction<boolean>>, page:number = 1, size:number = 10) => {
  const location = useLocation();
  const history = useHistory();
  const dispatch = useDispatch();
  const request = useAxiosPrivate();
