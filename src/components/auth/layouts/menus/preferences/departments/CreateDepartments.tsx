...
import { createDepartment } from '../../../../../../store/actions/preferencesActions';
...
function CreateDepartments({ drawer, onClose }: CreateDepartmentProps) {
  useCleanUp();
