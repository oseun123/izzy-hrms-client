...
import { system_departments } from '../../../../../../store/selectors/preferencesSelector';
...
import { deleteDepartment } from '../../../../../../store/actions/preferencesActions';
...
function ViewDepartments() {
  ...
  const departments: Department[] = useShallowEqualSelector(
    system_departments,
  ) as Department[];
